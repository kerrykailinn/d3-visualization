...
(function () {
  ...
  function injectSkeleton() {
    state.root.html(`
      <div id="${MODULE_ID}" class="ksj-wrap">
        <div class="content mb-2 ksj-macro-heading">
          <h3 class="title is-4 mb-1">一、中国—中东欧的增长趋势</h3>
          <p class="subtitle is-6 has-text-grey mt-2">
            观察2011—2020年中国—中东欧合作占比与合作量的年度变化，判断增长是否持续发生。<br>
            读图方式：实线看合作占比，虚线看合作量同比增速，圆点大小看年度合作规模。
          </p>
        </div>

        <div class="mb-5 ksj-macro-section">
          <div class="columns is-desktop ksj-macro-two-col">
            <div class="column is-four-fifths">
              <div class="ksj-chart-surface macro-large" id="ksj-macro-chart"></div>
            </div>
            <div class="column">
              <div class="ksj-macro-side-stack">
                <div class="ksj-zyl-side-card ksj-macro-side-card" id="ksj-macro-card"></div>
                <div class="ksj-zyl-side-card ksj-macro-side-card" id="ksj-macro-stats"></div>
                <div class="ksj-zyl-side-card ksj-macro-phase-card" id="ksj-macro-phase-card">
                  <div class="ksj-mini-title">阶段结论</div>
                  <div class="ksj-phase-conclusion">
                    <article class="ksj-phase-conclusion__item">
                      <h4>1. 起步快，但占比不稳</h4>
                      <p>2011—2012年合作占比快速上升，但2013—2015年回落，说明早期合作增长尚未形成稳定扩张。</p>
                    </article>
                    <article class="ksj-phase-conclusion__item">
                      <h4>2. 后期回升，进入扩展阶段</h4>
                      <p>2016年后合作占比重新上行，2018—2020年提升明显，说明中东欧合作在中国国际合作网络中的参与度增强。</p>
                    </article>
                    <article class="ksj-phase-conclusion__item">
                      <h4>3. 增长仍需看国家来源</h4>
                      <p>需要观察增长主要由核心国家拉动，还是扩散到更多国家。</p>
                    </article>
                  </div>
                </div>
              </div>
        ...
        <div class="mb-5 ksj-rank-section">
          <div class="content mb-3">
            <h3 class="title is-4 mb-1">二、合作国家排序</h3>
            <p class="subtitle is-6 has-text-grey mt-2">
              比较前后两个阶段各国合作排名变化，识别稳定核心国家与快速上升国家。<br>
              读图方式：左看前期排名，右看后期排名；线越粗，新增合作量越大；右侧绿色数字表示增长率。
            </p>
          </div>
            ...
            <div class="column">
              <div class="ksj-control-row ksj-rank-control-row">
                ...
                <div class="buttons has-addons mb-4 ksj-toolbar ksj-toolbar-under" id="ksj-rank-toolbar">
                  ...
                  <button class="button is-small ksj-pill is-light" data-focus="middle" title="后期排名或份额保持在中上水平">稳定</button>
              ...
              <div class="ksj-zyl-side-card" id="ksj-selected-card">
        ...
        <div class="box mb-5 ksj-zyl-box">
          <div class="content mb-3">
            <div class="ksj-balance-head">
              <div class="ksj-balance-head-copy">
                <h3 class="title is-4 mb-0">三、合作集中度变化</h3>
                <p class="subtitle is-6 has-text-grey ksj-balance-head-sub">
                  分析各阶段合作是否由少数核心国家主导，或逐步分散到更多国家。
                </p>
              </div>
              <div class="ksj-balance-head-toolbar">
              ...
              <div class="notification is-light ksj-link-bridge-card ksj-link-bridge-card--top" id="ksj-balance-link-card">
  ...
  function injectStyles() {
    ...
    const css = `
      ...
      .ksj-wrap {
        ...
        --blue-dark: ${PALETTE.blueStrong};
        --blue-light: ${PALETTE.blueLight};
        --orange: ${PALETTE.orangeLight};
        --orange-dark: ${PALETTE.orangeMid};
        --orange-strong: ${PALETTE.orangeStrong};
      ...
      .ksj-metric-value.is-growth-green {
        color: #15803d;
      }
      ...
      #ksj-macro-card.ksj-macro-side-card,
      #ksj-macro-stats.ksj-macro-side-card,
      #ksj-macro-phase-card.ksj-macro-phase-card {
        border: 0 !important;
      ...
      .ksj-macro-side-stack {
        display: flex;
        flex-direction: column;
        gap: 0;
      }

      .ksj-macro-metrics-duo {
        display: grid;
        gap: 2px;
        margin-bottom: 2px;
      }

      .ksj-macro-metrics-duo .ksj-card-big-value {
        margin-bottom: 0;
      }

      .ksj-macro-metrics-duo .ksj-card-lead {
        margin: 2px 0 4px;
        font-size: 13px;
        color: #667085;
        font-weight: 700;
      ...
      #ksj-macro-stats .ksj-country-grid:first-child {
        margin-top: 6px;
      }

      .ksj-macro-phase-card {
        margin-top: 6px;
        padding-top: 10px;
        padding-bottom: 2px;
      ...
      .ksj-phase-conclusion {
        display: grid;
        gap: 10px;
        margin-top: 4px;
      }

      .ksj-phase-conclusion__item h4 {
        margin: 0 0 4px;
        font-size: 13px;
        line-height: 1.45;
        font-weight: 800;
      ...
      .ksj-conclusion-bullets {
        margin: 0 0 12px;
        padding: 0;
        list-style: none;
      }

      .ksj-conclusion-bullets li {
        position: relative;
        padding-left: 16px;
        margin: 0 0 7px;
        color: #334155;
      ...
      .ksj-conclusion-bullets li::before {
        content: "-";
        position: absolute;
        left: 0;
        top: 0;
      ...
      .ksj-conclusion-section {
        margin-top: 14px;
      }

      .ksj-conclusion-section-title {
        margin: 0 0 8px;
        font-size: 15px;
        font-weight: 800;
        color: #172033;
      ...
      .ksj-conclusion-section .ksj-conclusion-bullets {
        margin-bottom: 0;
      }
      ...
      .ksj-bubble-node.ksj-focus-hit .ksj-bubble {
        stroke: ${PALETTE.orangeMid};
        stroke-width: 4.4px;
        filter: drop-shadow(0 10px 18px rgba(217,119,6,.28));
      }

      .ksj-ribbon.ksj-focus-hit {
        stroke-opacity: 1 !important;
        filter: drop-shadow(0 6px 14px rgba(31,63,111,.18));
      }
      ...
      .ksj-lorenz-segment.ksj-focus-hit {
        opacity: 1 !important;
        stroke: ${PALETTE.orangeMid} !important;
      ...
      .ksj-bubble-node.ksj-emphasis .ksj-bubble {
        stroke: ${PALETTE.orangeMid};
        stroke-width: 5px;
        filter: drop-shadow(0 0 0 rgba(217,119,6,.0)) drop-shadow(0 12px 20px rgba(217,119,6,.28));
      }
      ...
      .ksj-lorenz-country-dot.ksj-emphasis {
        stroke: ${PALETTE.orangeMid};
        stroke-width: 3.6;
        filter: drop-shadow(0 8px 18px rgba(217,119,6,.35));
      }
      ...
      .ksj-balance-head {
        display: grid;
        grid-template-columns: minmax(0, 1fr) auto minmax(320px, 360px);
        gap: 18px;
        align-items: start;
      }

      .ksj-balance-head-copy {
        min-width: 0;
      }

      .ksj-balance-head-sub {
        margin-top: 8px !important; 
        line-height: 1.45;
      }

      .ksj-balance-head-toolbar {
        display: flex;
        flex-direction: column;
      ...
      .ksj-balance-head-toolbar .ksj-control-title {
        margin: 0;
        text-align: left;
      }
      ...
      .ksj-ribbon.ksj-emphasis {
        stroke: ${PALETTE.orangeMid} !important;
        stroke-opacity: 1 !important;
        filter: drop-shadow(0 8px 16px rgba(217,119,6,.24));
      }
      ...
      .ksj-share-point.active-year {
        ...
        filter: drop-shadow(0 10px 18px rgba(217,119,6,.30));
      }
      ...
      .ksj-zyl-intro {
        border-left: 4px solid ${PALETTE.orangeMid};
        padding: 1.25rem;
      }
      ...
      .ksj-stat-negative { color: rgb(220, 38, 38) !important; }
      ...
      #ksj-macro-chart.ksj-chart-surface {
        border: 0 !important;
        background: transparent !important;
        border-radius: 0 !important;
        box-shadow: none !important;
      ...
      .ksj-rank-two-col > .column:last-child {
        padding-left: 0.2rem;
        margin-left: -8px;
      }
      ...
      #ksj-selected-card .ksj-country-grid.ksj-selected-grid .ksj-rank-change-stat {
        grid-column: 1 / -1;
      }
      ...
      #ksj-rank-flow .ksj-chart-title {
        font-size: 24px;
      }

      #ksj-rank-flow .ksj-chart-subtitle {
        font-size: 17px;
      }

      #ksj-lorenz-chart .ksj-chart-title {
        font-size: 22px;
      }

      #ksj-lorenz-chart .ksj-chart-subtitle {
        font-size: 16px;
      }
      ...
      #ksj-selected-card .ksj-country-type {
        font-size: 12.5px;
        margin-bottom: 10px;
      }

      #ksj-selected-card .ksj-bullet-list {
        font-size: 13px;
        line-height: 1.8;
      }

      #ksj-selected-card .ksj-bullet-panel {
        margin-top: 18px;
        padding: 16px 18px;
      }

      #ksj-selected-card .ksj-structure-overview-panel {
        padding-top: 18px;
        padding-bottom: 18px;
      }

      #ksj-rank-flow .ksj-ribbon.ksj-emphasis {
        stroke: ${PALETTE.orangeMid} !important;
        stroke-opacity: 1 !important;
        filter: drop-shadow(0 8px 16px rgba(217,119,6,.28));
      }

      #ksj-rank-flow .ksj-country-node.ksj-emphasis circle {
        fill: ${PALETTE.orangeMid} !important;
        stroke: #ffffff !important;
        stroke-width: 3px !important;
        filter: drop-shadow(0 8px 14px rgba(217,119,6,.26));
      }

      #ksj-rank-flow .ksj-growth-badge.ksj-emphasis text,
      #ksj-rank-flow .ksj-small-label.ksj-emphasis {
        fill: ${PALETTE.orangeMid} !important;
        font-weight: 950 !important;
      }
      ...
      @media screen and (min-width: 981px) {
        ...
        .ksj-rank-two-col .column:first-child {
          flex: 0 0 76%;
          max-width: 76%;
        }
        .ksj-rank-two-col .column:last-child {
  ...
  async function loadCsvFromCandidates(paths) {
    if (window.__loadLocalCsvRows) {
      try {
        const rows = await window.__loadLocalCsvRows(paths);
        if (rows && rows.length) return rows;
      } catch (error) {
        // fall through to original fetch-based loader
      }
    }
    let lastError = null;
  ...
  function summarizeStage(countries, key, label) {
    ...
    values.forEach(v => { v.share = total > 0 ? v.value / total : 0; });
    return {
      key,
      label,
      total,
  ...
  function renderHeroMetrics() {
    ...
    d3.select('#ksj-hero-metrics').html(`
      ${metricHTML('中东欧合作量增长', `${fmt.growth(ceeGrowth)}`, `${first.year}→${last.year}: ${fmt.int(first.cee)} 至 ${fmt.int(last.cee)}`, 'is-growth-green')}
      ${metricHTML('中国国际合作总量增长', `${fmt.growth(chinaGrowth)}`, `${first.year}→${last.year}: ${fmt.int(first.china)} 至 ${fmt.int(last.china)}`, 'is-growth-green')}
  ...
  function metricHTML(label, value, foot, valueClass = '') {
    return `
      <div class="ksj-metric">
        <div class="ksj-metric-label">${label}</div>
        <div class="ksj-metric-value ${valueClass}">${value}</div>
  ...
  function drawShareLensTimeline(box, data, width, height) {
    const margin = { top: 68, right: 104, bottom: 68, left: 54 };
    ...
    const growthSeries = data.map((d, i) => ({
      ...d,
      ceeYoYGrowthPct: i === 0 || !data[i - 1] || data[i - 1].cee <= 0
        ? null
        : ((d.cee - data[i - 1].cee) / data[i - 1].cee) * 100
    }));
    const finiteGrowth = growthSeries.map(d => d.ceeYoYGrowthPct).filter(Number.isFinite);
    const maxYoYGrowth = d3.max(finiteGrowth) || 0;
    const minYoYGrowth = d3.min(finiteGrowth) || 0;
    const maxD = data.find(d => d.proportion === maxShare);
    const minD = data.find(d => d.proportion === minShare);
    const maxGrowthPoint = growthSeries
      .filter(d => Number.isFinite(d.ceeYoYGrowthPct))
      .sort((a, b) => d3.descending(a.ceeYoYGrowthPct, b.ceeYoYGrowthPct))[0] || null;
    ...
    const yGrowth = d3.scaleLinear()
      .domain([
        Math.min(-10, minYoYGrowth * 1.12, 0),
        Math.max(10, maxYoYGrowth * 1.12, 0)
      ])
      .nice()
      .range([innerH, 0]);
    ...
    const x2015 = x(2015);
    const x2016 = x(2016);
    const pointStep = Number.isFinite(x2012 - x2011) ? (x2012 - x2011) : innerW / Math.max(data.length - 1, 1);
    const leftEdge = Math.max(0, x2011 - pointStep * 0.62);
    const rightEdge = Math.min(innerW, (x(last.year) ?? innerW) + pointStep * 0.62);
    const stageSplit = Number.isFinite(x2015) && Number.isFinite(x2016) ? (x2015 + x2016) / 2 : innerW / 2;

    const phaseLayer = g.append('g').attr('class', 'ksj-phase-layer');
    phaseLayer.append('rect')
      .attr('x', leftEdge)
      .attr('y', 0)
      .attr('width', Math.max(0, stageSplit - leftEdge))
      .attr('height', innerH)
      .attr('fill', '#ECEFF4')
      .attr('rx', 14)
      .attr('opacity', 1);
    phaseLayer.append('rect')
      .attr('x', stageSplit)
      .attr('y', 0)
      .attr('width', Math.max(0, rightEdge - stageSplit))
      .attr('height', innerH)
      .attr('fill', '#D8E7F5')
      .attr('rx', 14)
      .attr('opacity', 1);
    phaseLayer.append('text')
      ...
      .text('2011—2015｜起步与波动期');
    phaseLayer.append('text')
      .attr('x', stageSplit + 16)
      .attr('y', 22)
      .attr('fill', '#43638d')
      .attr('font-size', 12)
      .attr('font-weight', 780)
      .text('2016—2020｜回升与扩展期');

    g.append('g')
      .attr('class', 'ksj-grid')
      .call(d3.axisLeft(y).ticks(5).tickSize(-innerW).tickFormat(''));

    if (Number.isFinite(x2012)) {
      const policyY = Math.max(26, y(maxShare) - 18);
      const policy = g.append('g').attr('class', 'ksj-policy-marker');
      policy.append('line')
        .attr('x1', x2012)
        .attr('x2', x2012)
        .attr('y1', 0)
    ...
    g.append('path')
      .datum(data)
      .attr('fill', 'none')
      .attr('stroke', PALETTE.blueMid)
      .attr('stroke-width', 3.8)
      .attr('stroke-linecap', 'round')
      .attr('d', line);

    const growthLine = d3.line()
      .defined(d => Number.isFinite(d.ceeYoYGrowthPct))
      .x(d => x(d.year))
      .y(d => yGrowth(d.ceeYoYGrowthPct))
      .curve(d3.curveMonotoneX);
    ...
    g.append('text')
      ...
      .text('年份');
    g.append('text')
      .attr('transform', `translate(${innerW + 74}, ${innerH / 2}) rotate(90)`)
      .attr('text-anchor', 'middle')
      .attr('fill', '#6b88a8')
      .attr('font-size', 12)
      .attr('font-weight', 820)
    ...
    svg.append('g')
      ...
      .attr('transform', `translate(${margin.left - 10}, 28)`)
      .call(gLegend => {
        const fs = 13;
        const legendY = 0;
        const textY = 4;
        gLegend.append('line').attr('x1', 0).attr('x2', 38).attr('y1', legendY).attr('y2', legendY).attr('stroke', PALETTE.blueMid).attr('stroke-width', 4.5).attr('stroke-linecap', 'round');
        gLegend.append('text').attr('x', 50).attr('y', textY).attr('fill', '#667085').attr('font-size', fs).attr('font-weight', 780).text('实线：合作占比');
        gLegend.append('line').attr('x1', 238).attr('x2', 278).attr('y1', legendY).attr('y2', legendY).attr('stroke', '#7fb0de').attr('stroke-width', 2.8).attr('stroke-dasharray', '7 6').attr('stroke-linecap', 'round').attr('opacity', 0.45);
        gLegend.append('text').attr('x', 292).attr('y', textY).attr('fill', '#667085').attr('font-size', fs).attr('font-weight', 780).text('虚线：合作量同比增速');
        gLegend.append('circle').attr('cx', 548).attr('cy', legendY).attr('r', 8).attr('fill', '#fff').attr('stroke', PALETTE.blueMid).attr('stroke-width', 3.2);
        gLegend.append('text').attr('x', 566).attr('y', textY).attr('fill', '#667085').attr('font-size', fs).attr('font-weight', 780).text('圆点大小：年度合作量');
      });
  ...
  function macroMetricsDuoHTML(record) {
    return `
      <div class="ksj-macro-metrics-duo">
        <div>
          <div class="ksj-card-big-value">${fmt.pct(record.proportion)}%</div>
          <div class="ksj-card-lead">合作占比</div>
        </div>
        <div>
          <div class="ksj-card-big-value">${fmt.int(record.cee)}</div>
          <div class="ksj-card-lead">年度论文量</div>
        </div>
      </div>
    `;
  }
  ...
  function renderMacroCard(d) {
    ...
    const statsEl = d3.select('#ksj-macro-stats');
    if (el.empty() || statsEl.empty()) return;
    const data = state.data.yearly;
    ...
    if (!d) {
      el.html(`
        ...
        ${macroMetricsDuoHTML(last)}
        <div class="ksj-muted" style="margin:4px 0 0;">
          默认显示末期年份。悬停或点击折线图上的年份，可查看年度合作量、占比和较基准变化。
        </div>
      `);
      statsEl.html(`
        <div class="ksj-country-grid" style="grid-template-columns:1fr;">
          ${countryStatHTML('阶段位置', last.year <= 2015 ? '起步与波动期' : '回升与扩展期')}
        </div>
        <div class="ksj-country-grid">
          ${countrySplitStatHTML('较2011年', '占比', `${formatPPPct(periodChange)}`)}
          ${countryStatHTML('较2011年合作量', `${first && first.cee ? `${(last.cee / first.cee - 1) >= 0 ? '+' : '-'}${fmt.pct(Math.abs((last.cee / first.cee - 1) * 100))}%` : '—'}`)}
        </div>
      `);
      return;
    }
    ...
    const phaseLabel = d.year <= 2015 ? '起步与波动期' : '回升与扩展期';

    el.html(`
      <div class="ksj-mini-title">${active.year} 年度观察</div>
      ${macroMetricsDuoHTML(active)}
    `);
    statsEl.html(`
      <div class="ksj-country-grid" style="grid-template-columns:1fr;">
        ${countryStatHTML('阶段位置', phaseLabel)}
      </div>
      <div class="ksj-country-grid">
        ${countrySplitStatHTML('较2011年', '占比', `${formatPPPct(shareChange)}`)}
        ${countryStatHTML('较2011年合作量', `${firstGrowth >= 0 ? '+' : '-'}${fmt.pct(Math.abs(firstGrowth))}%`)}
      </div>
    `);
  }
  ...
  function showYearTooltip(event, d) {
    const yearly = state.data.yearly || [];
    const idx = yearly.findIndex(row => row.year === d.year);
    const prev = idx > 0 ? yearly[idx - 1] : null;
    const delta = prev ? (d.proportion - prev.proportion) : null;
    const deltaColor = delta >= 0 ? PALETTE.positive : PALETTE.negative;
    const html = `
      <div class="ksj-tooltip-title">${d.year}</div>
      <div class="ksj-tooltip-row"><span>中东欧合作量</span><b style="color:${PALETTE.orangeLight};">${fmt.int(d.cee)}</b></div>
      <div class="ksj-tooltip-row"><span>中国国际合作总量</span><b style="color:${PALETTE.blueLight};">${fmt.int(d.china)}</b></div>
      <div class="ksj-tooltip-row"><span>合作占比</span><b style="color:${PALETTE.blueLight};">${fmt.pct(d.proportion)}%</b></div>
      <div class="ksj-tooltip-row"><span>vs去年占比</span><b style="color:${delta == null ? '#667085' : deltaColor};">${delta == null ? '—' : formatPPPct(delta)}</b></div>
    `;
  ...
  function renderRankFlow() {
    ...
    const width = Math.max(1320, el.clientWidth || 1400);
    const rowH = 48;
    const height = Math.max(1160, rows.length * rowH + 430);
    const margin = { top: 176, right: 328, bottom: 164, left: 214 };
    const innerH = height - margin.top - margin.bottom;
    const leftX = margin.left;
    const rightX = width - margin.right;
    const growthX = width - 120;

    const diffExtent = d3.extent(rows, d => Math.max(0, d.diff));
    const widthScale = d3.scaleSqrt().domain(diffExtent).range([5.5, 23]);
    const nodeRadius = d3.scaleSqrt().domain(d3.extent(rows, d => d.p2)).range([5, 10]);

    const svg = d3.select(el).html('').append('svg')
      .attr('viewBox', `0 0 ${width} ${height}`)
      .attr('role', 'img')
      .attr('aria-label', 'Rank flow chart for CEE countries with numeric growth labels');
    ...
    const badge = svg.append('g').attr('class', 'ksj-growth-badge-layer')
      ...
      .attr('data-country', d => d.country)
      .attr('transform', d => `translate(${growthX},${y2(d.rank2)})`)
      .on('mouseenter', (event, d) => setCountryHover(event, d))
      .on('mousemove', (event, d) => showCountryTooltip(event, d))
      .on('mouseleave', clearCountryHover)
      .on('click', (event, d) => selectCountry(d));
    ...
    types.forEach((type, i) => {
      ...
      item.append('circle').attr('r', 8.5).attr('fill', typeColor(type));
      item.append('text').attr('x', 18).attr('y', 6).attr('fill', '#667085').attr('font-size', 17).attr('font-weight', 900).text(typeLabel(type));
    });
    applyHighlighting();
  }
  ...
  function drawRankLabels(svg, rows, x, y, side) {
    ...
    group.selectAll(`text.${side}-rank-label`)
      ...
      .attr('data-country', d => d.country)
      .attr('x', x + dx)
      .attr('y', d => y(side === 'left' ? d.rank1 : d.rank2) + 5)
...
.text('气泡面积表示国家合作量；悬停或点击国家后，右侧Lorenz曲线会同步定位。');
    ...
    const typeLegend = svg.append('g')
      .attr('class', 'ksj-bubble-type-legend')
      .attr('transform', 'translate(26,88)');
    const typeItems = ['core', 'middle', 'chaser', 'tail'];
    typeItems.forEach((type, i) => {
      const item = typeLegend.append('g').attr('transform', `translate(${i * 144},0)`);
      item.append('circle')
        .attr('r', 8.5)
        .attr('cx', 0)
        .attr('cy', 0)
    ...
    const g = svg.append('g').attr('transform', 'translate(18,126)');
    g.append('circle')
      .attr('cx', (width - 36) / 2)
  ...
  function renderLorenzChart() {
    ...
    const height = 950;
    const margin = { top: 132, right: 72, bottom: 186, left: 78 };
    const innerW = width - margin.left - margin.right;
    const innerH = height - margin.top - margin.bottom;
...
.text('蓝线表示合作量累计分布；越偏离均衡线，集中度越高。');
  ...
  function renderConclusion() {
    ...
    const top3Rows = s2.values.slice(0, 3);
    const top3Distribution = top3Rows
      .map(row => `${row.countryCn}（${fmt.pct1(row.share * 100)}%）`)
      .join('、');

    d3.select('#ksj-conclusion').html(`
      <h4 class="ksj-conclusion-title">合作总体概览：</h4>
      <div class="ksj-conclusion-section">
        <p class="ksj-conclusion-section-title">1. 核心国家集中度保持稳定</p>
        <ul class="ksj-conclusion-bullets">
          <li>2016–2020 年 TOP3（${top3Names}）合作占比 <b>${fmt.pct1(s2.top3Share * 100)}%</b>，较前期略增 <b class="${statToneClass(formatPP(top3Change))}">${formatPP(top3Change)}</b>。</li>
        </ul>
      </div>

      <div class="ksj-conclusion-section">
        <p class="ksj-conclusion-section-title">2. Top5 国家略有分散</p>
        <ul class="ksj-conclusion-bullets">
          <li>相比前期下降 <b class="${statToneClass(formatPP(top5Change))}">${formatPP(top5Change)}</b>，说明部分合作向更多国家扩展。</li>
        </ul>
      </div>

      <div class="ksj-conclusion-section">
        <p class="ksj-conclusion-section-title">3. 合作量分布</p>
        <ul class="ksj-conclusion-bullets">
          <li>${top3Distribution} 仍为最大贡献者。</li>
          <li>国家贡献集中度：Lorenz 曲线显示合作呈偏右分布，说明大部分合作由少数核心国家贡献，尾部国家贡献较小但逐渐增加。</li>
        </ul>
      </div>

      <div class="ksj-conclusion-section">
        <p class="ksj-conclusion-section-title">4. 整体趋势洞察</p>
        <ul class="ksj-conclusion-bullets">
          <li>核心国家合作稳定，中小国家合作逐步分散，合作体系在保持核心稳定的同时，正在实现“多国参与 + 分布优化”。</li>
        </ul>
      </div>
    `);
  }
  ...
  function renderSelectedCard(d, temporary = false) {
    ...
    if (!d) {
      el.html(`
        <div class="ksj-mini-title">国家结构概览</div>
        <div class="ksj-muted ksj-card-lead">核心国家稳定领先，追赶国家增长率高但基数较小。</div>
        <div class="ksj-bullet-panel ksj-structure-overview-panel">
          <ul class="ksj-bullet-list">
            <li><b>核心国家：</b><span class="ksj-country-highlight">波兰</span>、<span class="ksj-country-highlight">捷克</span>、<span class="ksj-country-highlight">希腊</span>保持前三，构成合作主支撑。</li>
            <li><b>稳定国家：</b><span class="ksj-country-highlight">匈牙利</span>、<span class="ksj-country-highlight">罗马尼亚</span>、<span class="ksj-country-highlight">塞尔维亚</span>等排名基本稳定。</li>
            <li><b>追赶国家：</b><span class="ksj-country-highlight">保加利亚</span>、<span class="ksj-country-highlight">爱沙尼亚</span>、<span class="ksj-country-highlight">拉脱维亚</span>等增长明显，但整体规模仍较小。</li>
            <li><b>长尾国家：</b>合作量较低，主要位于合作结构外围。</li>
          </ul>
        </div>
      `);
      return;
    ...
    const rankNarrative = countryRankNarrative(d);
    el.html(`
      <div class="ksj-mini-title">${temporary ? '悬停国家' : '选中国家'}</div>
      <div class="ksj-country-name">${d.countryCn}</div>
      <div class="ksj-country-type">${d.typeLabel}</div>
      <div class="ksj-muted ksj-card-lead">${rankNarrative}</div>
      <div class="ksj-country-grid ksj-clean-grid ksj-selected-grid">
        ...
        ${countryStatHTML('排名变化', rankText, 'ksj-rank-change-stat')}
      </div>
    `);
  }

  function countryRankNarrative(d) {
    const rankLead = d.rankChange > 0
      ? `排名由第 ${d.rank1} 升至第 ${d.rank2}`
      : d.rankChange < 0
        ? `排名由第 ${d.rank1} 降至第 ${d.rank2}`
        : `排名保持第 ${d.rank2}`;
    const valueLead = d.diff >= 0
      ? `合作量由 ${fmt.int(d.p1)} 篇增至 ${fmt.int(d.p2)} 篇`
      : `合作量由 ${fmt.int(d.p1)} 篇降至 ${fmt.int(d.p2)} 篇`;
    let explanation = '说明其合作位置相对稳定，变化主要体现在合作规模调整。';
    if (d.rankChange > 0) {
      explanation = d.type === 'chaser'
        ? '说明其合作地位明显上升，兼具规模扩张与快速追赶特征。'
        : '说明其相对位置提升，后期合作贡献进一步增强。';
    } else if (d.rankChange < 0) {
      explanation = d.diff >= 0
        ? '说明其合作规模仍在扩大，但其他国家增长更快，导致相对排名回落。'
        : '说明其合作规模与相对排名均有所回落，需要关注后期参与度变化。';
    } else if (d.type === 'core' || d.type === 'middle') {
      explanation = '说明其合作地位稳定，但增长主要体现为规模扩张。';
    } else if (d.type === 'tail') {
      explanation = '说明其仍处于长尾位置，后期合作扩张尚未改变整体结构地位。';
    }
    return `${rankLead}，${valueLead}，${explanation}`;
  }
  ...
  function countryStatHTML(label, value, extraClass = '') {
    const className = `ksj-country-stat${extraClass ? ` ${extraClass}` : ''}`;
    return `<div class="${className}"><span>${label}</span><b class="${statToneClass(value)}">${value}</b></div>`;
  }

  function countrySplitStatHTML(label, subLabel, value) {
    return `<div class="ksj-country-stat"><span>${label}</span><span class="ksj-country-stat-sub">${subLabel}</span><b class="${statToneClass(value)}">${value}</b></div>`;
  }
  ...
  function formatPPPct(value) {
    return `${value >= 0 ? '+' : ''}${d3.format('.2f')(value)}pp`;
  }
  ...
  function showCountryTooltip(event, d) {
    const rankColor = d.rankChange > 0 ? PALETTE.positive : (d.rankChange < 0 ? PALETTE.negative : PALETTE.blueLight);
    const html = `
      <div class="ksj-tooltip-title">${d.countryCn} · ${d.typeLabel}</div>
      <div class="ksj-tooltip-row"><span>2011–2015</span><b style="color:${PALETTE.blueLight};">${fmt.int(d.p1)}</b></div>
      <div class="ksj-tooltip-row"><span>2016–2020</span><b style="color:${PALETTE.orangeLight};">${fmt.int(d.p2)}</b></div>
      <div class="ksj-tooltip-row"><span>增长率</span><b style="color:${Number.isFinite(d.growthRate) && d.growthRate >= 0 ? PALETTE.positive : PALETTE.negative};">${formatGrowthRate(d.growthRate)}</b></div>
      <div class="ksj-tooltip-row"><span>后期份额</span><b style="color:${PALETTE.orangeLight};">${fmt.pct1(d.share2 * 100)}%</b></div>
      <div class="ksj-tooltip-row"><span>排名变化</span><b style="color:${rankColor};">${d.rankChange > 0 ? '+' : ''}${d.rankChange}</b></div>
    `;
    moveTooltip(event, html);
  }
  ...
  function countryShouldShow(d, focus, activeCountry) {
    ...
    if (focus === 'middle') return d.type === 'middle';
